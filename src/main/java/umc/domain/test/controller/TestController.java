...
public class TestController {
    ...
    public ApiResponse<TestResDTO.Testing> test() throws Exception {
        ...
        return ApiResponse.onSuccess(code, TestConverter.toTestingDTO("This is a Test!!"));
    }
    ...
    public ApiResponse<TestResDTO.Exception> exception(
        ...
        GeneralSuccessCode code = GeneralSuccessCode.OK;
        return ApiResponse.onSuccess(code, TestConverter.toExceptionDTO("This is a Test!!"));
    }
}
